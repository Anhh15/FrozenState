...
### 22. Lỗ Hổng Nhân Bản Vật Phẩm Do Rollback Bất Cân Xứng & Mô Hình Draw-First Two-Phase Commit
- **Vấn đề:** Nếu trừ tiền trước và trao item dần qua từng lượt mở rương trong vòng lặp, khi phát sinh ngoại lệ runtime ở lượt giữa chừng (ví dụ: mua 5 rương, lỗi ở rương 3), cơ chế rollback hoàn lại $100\%$ số tiền đã trừ nhưng không thể thu hồi các item đã trao ở rương 1 và 2, tạo ra lỗ hổng nhân bản item và nhận đồ miễn phí.
- **Giải pháp:** Chuyển đổi toàn diện sang mô hình **Draw-First Two-Phase Commit**:
  1. *Pha 1 (Mô phỏng trong RAM)*: Chạy $N$ lượt rút bằng `SimulateOneDraw(Player, Chest, RefundPrice, TemporaryOwned)`. Kiểm tra và tính toán hoàn tiền trên bộ nhớ đệm mà tuyệt đối không chạm vào Profile DataStore.
  2. *Pha 2 (Commit nguyên tử)*: Khi toàn bộ $N$ lượt đều thành công mỹ mãn, hệ thống đồng thời trừ tiền ròng (`AddMoney`), cộng tiền hoàn lại và ghi nhận toàn bộ item mới vào Profile. Nếu Pha 1 gặp bất kỳ lỗi nào, giao dịch lập tức bị hủy mà dữ liệu người chơi chưa từng bị biến đổi dở dang.
- **File liên quan:** [ShopService.lua](../../src/ServerScriptService/Services/ShopService.lua), [DataService.lua](../../src/ServerScriptService/Services/DataService.lua)

### 23. Mất Mát Tiến Trình Nhiệm Vụ PlayTime Khi Thoát Game Do Kiểm Tra IsDescendantOf Quá Sớm
